...
A Payment Application is
    ...
    ----------
    id : str
        The unique Lockstep Platform ID number of this Payment Application; NOT
        the customer's ERP key
    include : str
        To fetch additional data on this object, specify the list of elements to
        retrieve. Available collections: Invoice
    """
...
The PATCH method allows you to change specific
    ...
    ----------
    id : str
        The unique Lockstep Platform ID number of the Payment Application to
