...
An Attachment
    is a file that can be attached to various account attributes within
    Lockstep. Attachments can be used for invoices, bills, or any other
    external files that you wish to track and have access to. Attachments
    represents an Attachment and a number of different metadata attributes
    related to the creation, storage, and ownership of the
    Attachment.
...
An Attachment is a file that can be attached to
...
An Attachment is a file that can be attached to various
...
An Attachment is a file that
    can be attached to various account attributes within Lockstep.
