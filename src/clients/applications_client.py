...
An Application
    ...
    customers can browse and find your Application on the Lockstep Platform
    Marketplace. When a customer adds an Application to their account, they
...
See [Applications and
    ...
    include : str
        ...
        retrieve. Available collections: Notes, Attachments, CustomFields
    """
...
The PATCH method allows you to change specific values on
    ...
    create Applications by working with your Lockstep business development
    manager and publish them on the platform so that customers can browse
    and find your Application on the Lockstep Platform Marketplace. When a
...
Deletes the Application referred to by this unique identifier.
    ...
    within the Lockstep Platform. You can create Applications by working
    with your Lockstep business development manager and publish them on the
    platform so that customers can browse and find your Application on the
    Lockstep Platform Marketplace. When a customer adds an Application to
